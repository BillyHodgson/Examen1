...
namespace WBL
{
    ...
    public class PuestoService : IPuestoService
    {
        ...
        public async Task<IEnumerable<PuestosEntity>> Get()
        {
            try
            {
                var result = sql.QueryAsync<PuestosEntity>("ObtenerPuesto");
        ...
        public async Task<PuestosEntity> GetById(PuestosEntity entity)
        {
            try
            {
                var result = sql.QueryFirstAsync<PuestosEntity>("ObtenerPuesto", new
                {
                    entity.Id_Puesto
                });
        ...
        public async Task<DBEntity> Create(PuestosEntity entity)
        {
            try
            {
                var result = sql.ExecuteAsync("InsertarPuesto", new
                {
                    entity.Nombre,
                    entity.Salario,
                    entity.Estado
        ...
        public async Task<DBEntity> Update(PuestosEntity entity)
        {
            try
            {
                var result = sql.ExecuteAsync("ActualizarPuesto", new
                {
                    entity.Id_Puesto,
                    entity.Nombre,
                    entity.Salario,
        ...
        public async Task<DBEntity> Delete(PuestosEntity entity)
        {
            try
            {
                var result = sql.ExecuteAsync("EliminarPuesto", new
                {
                    entity.Id_Puesto,
                });
